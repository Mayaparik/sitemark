...
function Footer() {
    return (
        <section className="lg:px-14 px-6 bg-slate-950">
                    ...
                    <div className="flex justify-between">
                        <div>
                            <ul className="space-y-1">
                                ...
                                {
                                    ["Features", "Testimonials", "Highlights", "Pricing", "FAQs"].map((list) => (
                                        <li key={list}>
                                            <Link className="relative !text-slate-500 font-bold pb-1 text-sm group">{list}
                                                <span
                        ...
                        <div>
                            <ul className="space-y-1">
                                ...
                                {
                                    ["About us", "Careers", "Press"].map((list) => (
                                        <li key={list}>
                        ...
                        <div>
                            <ul className="space-y-1">
                                ...
                                {
                                    ["Terms", "Privacy", "Contact"].map((list) => (
                                        <li key={list}>
                                            <Link to="" className="relative !text-slate-500 font-bold pb-1 text-sm group">
                                                {list}
                                                <span
